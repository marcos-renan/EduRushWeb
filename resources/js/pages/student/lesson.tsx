                        ...
                        <div className="rounded-3xl border border-[#BFE0FF] bg-white p-6 text-center dark:border-[#263753] dark:bg-[#111C33]">
                            ...
                            <div className="mt-5 flex flex-wrap justify-center gap-2">
                                <button
                                    type="button"
                                    onClick={resetAttempt}
                                    className="cursor-pointer rounded-xl border border-[#BFE0FF] bg-[#F8FBFF] px-4 py-2 text-sm font-bold text-[#2F3E63] transition hover:-translate-y-0.5 hover:border-[#93C5FF] hover:bg-[#EAF3FF] hover:shadow-md dark:border-[#263753] dark:bg-[#0B1428] dark:text-[#B4C3E3] dark:hover:border-[#375786] dark:hover:bg-[#16233D]"
                                >
                                    Tentar de novo
                                </button>
                                <Link
